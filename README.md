...
```
    ...
    c:\Users\kanja\OneDrive\Documents\group_4_project_phase_2\group_4_project_phase_2\im.db
    169443328 <class 'bytes'>
    

# 3. Loading Data from files and databases
...
# 6. Merging of the two datasets (IMDB AND BOM)
